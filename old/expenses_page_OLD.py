...
from category_creation import CategoryCreationPage, resource_path
...
class IncomeFrame(ctk.CTkScrollableFrame):
    def __init__(self, master, **kwargs):
        ...
        self.master = master
        self.new_category = CategoryCreationPage(master)
        self.new_category.withdraw()

        self.name_label = ctk.CTkLabel(self, text_color="black", text="Основные доходы", font=("Arial", 24))
        self.name_label.grid(row=0, column=0, columnspan=2, padx=20, pady=10, sticky="e")
